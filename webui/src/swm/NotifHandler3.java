...
/**
 * Servlet implementation class NotifHandler3
 */
@WebServlet("/NotifHandler3")
public class NotifHandler3 extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if (resource.getResourceType().intValue() == M2MRESOURCETYPE.CONTENTINSTANCE.getvalue().intValue()) {
			...
			String sql = "CREATE TABLE IF NOT EXISTS newt12 (id Integer Primary Key AUTOINCREMENT, ci text, time text);";
			try{
			...
			String s = "INSERT INTO newt12(ci,time) VALUES(?,?)";
			try(
