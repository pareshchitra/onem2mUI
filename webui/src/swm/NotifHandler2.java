...
/**
 * Servlet implementation class NotifHandler2
 */
@WebServlet("/NotifHandler2")
public class NotifHandler2 extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		System.out.println("Notification2 Received");
		...
		if (resource.getResourceType().intValue() == M2MRESOURCETYPE.CONTENTINSTANCE.getvalue().intValue()) {
			...
			/*
			String sql = "CREATE TABLE IF NOT EXISTS newt2 (id Integer Primary Key AUTOINCREMENT, ci text, time text);";
			try{
			...
			*/
			...
			String s = "INSERT INTO newt2(ci,time) VALUES(?,?)";
			try(
